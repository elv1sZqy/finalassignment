...
public class MailUtil {
     ...
     * @param content   邮件内容
     */
    public static void sendMail(String receive,String subject,String receiver, String content){
        ...
        try {
            ...
            MimeMessage message = creatMimeMessage(session, systemEmail, receive,receiver,content,subject);
            //rcjuqnheuxqaighf   授权码
            Transport transport = session.getTransport("smtp");
            //连接
            transport.connect(systemEmail,password);
            //发送
     ...
     * @throws Exception
     */
    public static MimeMessage creatMimeMessage(Session session,String send,String receive,String receiver,
                                        String content,String subject) throws Exception {
        MimeMessage message = new MimeMessage(session);
        Address address = new InternetAddress(send,"全球最强古诗搜索平台","utf-8");
